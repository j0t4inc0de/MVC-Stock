...
class  VistaProducto:
    ...
    def listo_click(self):
        nombreProducto = self.entry_nombre_producto.get()
        precioProducto = self.entry_precio_producto.get()
        nombreEstado = self.entry_nombre_estado.get()
        nombreCategoria = self.entry_nombre_ctg.get()
