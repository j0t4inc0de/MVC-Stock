...
class VistaPrincipal:
    def __init__(self, modelo_stock):
        ...
        self.treeview = ttk.Treeview(self.ventanaPrincipal, columns=("Nombre", "Precio", "Cantidad", "Estado", "Categoría"), show="headings", height=15)
        ...
        self.entry_buscar = ttk.Entry(self.ventanaPrincipal, width=60)
        ...
        self.label_buscar = ttk.Button(self.ventanaPrincipal, image=self.imagen_buscar).place(x=380,y=0)
        ...
        self.label_actualizar = ttk.Button(self.ventanaPrincipal, image=self.imagen_actualizar).place(x=440,y=0)
        ...
        self.label_anadir = ttk.Button(self.ventanaPrincipal, image=self.imagen_anadir).place(x=515,y=0)
        ...
        self.label_eliminar = ttk.Button(self.ventanaPrincipal, image=self.imagen_eliminar).place(x=580,y=0)
        ...
        self.label_editar = ttk.Button(self.ventanaPrincipal, image=self.imagen_editar).place(x=646,y=0)
